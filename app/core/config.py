...
QBOX_WIFI_AGENT_MIN_SIGNAL_DBM = get_int_setting(
    "QBOX_WIFI_AGENT_MIN_SIGNAL_DBM",
    -65,
)
QBOX_WIFI_AGENT_SWITCH_HYSTERESIS_DBM = get_int_setting(
    "QBOX_WIFI_AGENT_SWITCH_HYSTERESIS_DBM",
    10,
)
QBOX_WIFI_AGENT_SWITCH_COOLDOWN_SECONDS = get_int_setting(
    "QBOX_WIFI_AGENT_SWITCH_COOLDOWN_SECONDS",
    180,
)
QBOX_WIFI_AGENT_POST_CONNECT_ROAM_HOLD_SECONDS = get_int_setting(
    "QBOX_WIFI_AGENT_POST_CONNECT_ROAM_HOLD_SECONDS",
    600,
)
QBOX_WIFI_AGENT_INTERNET_CHECK_INTERVAL_SECONDS = get_int_setting(
    "QBOX_WIFI_AGENT_INTERNET_CHECK_INTERVAL_SECONDS",
    30,
)
QBOX_WIFI_AGENT_RECONNECT_INTERVAL_SECONDS = get_int_setting(
    "QBOX_WIFI_AGENT_RECONNECT_INTERVAL_SECONDS",
    120,
)
QBOX_WIFI_AGENT_CONNECTIVITY_CHECK_METHOD = get_str_setting(
    "QBOX_WIFI_AGENT_CONNECTIVITY_CHECK_METHOD",
    "dns",
).lower()
QBOX_WIFI_AGENT_CONNECTIVITY_CHECK_TIMEOUT_SECONDS = get_float_setting(
    "QBOX_WIFI_AGENT_CONNECTIVITY_CHECK_TIMEOUT_SECONDS",
    5.0,
)
QBOX_WIFI_AGENT_CONNECTIVITY_CHECK_RETRIES = get_int_setting(
    "QBOX_WIFI_AGENT_CONNECTIVITY_CHECK_RETRIES",
    2,
)
QBOX_WIFI_AGENT_CONNECTIVITY_DNS_HOST = get_str_setting(
    "QBOX_WIFI_AGENT_CONNECTIVITY_DNS_HOST",
    "one.one.one.one",
)
QBOX_WIFI_AGENT_CONNECTIVITY_PING_HOST = get_str_setting(
    "QBOX_WIFI_AGENT_CONNECTIVITY_PING_HOST",
    "1.1.1.1",
)
QBOX_WIFI_AGENT_CONNECTIVITY_HTTP_URL = get_str_setting(
    "QBOX_WIFI_AGENT_CONNECTIVITY_HTTP_URL",
    "https://connectivitycheck.gstatic.com/generate_204",
)
QBOX_WIFI_AGENT_BLE_DISCOVERABLE_TIMEOUT_SECONDS = get_int_setting(
    "QBOX_WIFI_AGENT_BLE_DISCOVERABLE_TIMEOUT_SECONDS",
    300,
)
QBOX_WIFI_AGENT_BLE_REENABLE_AFTER_TIMEOUT = get_bool_setting(
    "QBOX_WIFI_AGENT_BLE_REENABLE_AFTER_TIMEOUT",
    True,
)
QBOX_WIFI_AGENT_WIFI_CONNECT_TIMEOUT_SECONDS = get_int_setting(
