...
class QBoxControlService:
    ...
    def handle_mqtt_reconnect(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        response = {
            ...
            "internal_camera_status": status_snapshot.get("internal_camera_status", "not working"),
            "external_camera_status": status_snapshot.get("external_camera_status", "not working"),
